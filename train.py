...
def set_flags():
    ...
    # About data
    Flags.DEFINE_string('data_dir', './data/K28_HR', 'data directory')
    Flags.DEFINE_string('HR_data_dir', './data/HR data', 'HR data directory')
    Flags.DEFINE_string('LR_data_dir', './data/LR data', 'LR data directory')
